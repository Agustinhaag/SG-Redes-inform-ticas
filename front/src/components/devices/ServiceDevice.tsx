                        ...
                        {deviceStatus !== "disconnected" && (
                          <div className="flex flex-col gap-2 mb-1">
                            ...
                            <p className="text-neutral-400 sm:text-base text-sm">
                              Inicialmente, dispone de 5000 mensajes gratuitos
                              de forma mensual.
                            </p>
                            <p className="text-neutral-400 sm:text-base text-sm">
                              Actualmente, el proceso de envío de mensajes es
                              lento. Una mayor velocidad podría ser interpretada
                              como spam por la empresa WhatsApp, resultando en
                              el bloqueo del número de teléfono. Para evitar
                              esta situación, el envío es de 1 minuto por
                              mensaje.
                            </p>
                            <p className="text-neutral-400 sm:text-base text-sm">
                              Por lo tanto, este software no debe utilizarse
                              para informar emergencias a los clientes (por
                              ejemplo, la caída imprevista de equipos). Su uso
                              está diseñado para comunicaciones anticipadas,
                              como avisos de vencimiento, mantenimientos
                              programados, etc.
                            </p>
                          </div>
                        )}
                          ...
                          {deviceStatus === "disconnected" && (
                            <div className="text-custom-white flex flex-col gap-1">
                              ...
                              <ul className="list-decimal ml-4">
                                ...
                                <li>
                                  En esta página, presione el botón Generar
                                  código QR.
                                </li>
                                <li>
                                  Con su teléfono, escanee el código QR generado
                                  en esta página. Una vez escaneado el código
                                  QR, su teléfono estará habilitado para enviar
